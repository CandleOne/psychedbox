...
const body = JSON.stringify([
  ...
  },
  {
    ...
    text: "One of the true OGs of psychedelic podcasting, The Entheogenic Evolution has been holding space for these conversations long before the current renaissance made them trendy. The show covers entheogens — psychoactive substances used in spiritual contexts — with an emphasis on personal transformation, ceremony, and the broader counter-cultural significance of these experiences. Its extensive back catalog is a treasure trove for listeners who want to understand the roots of the modern psychedelic movement.",
  },
  {
    type: "image-text",
