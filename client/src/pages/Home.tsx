        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col justify-center px-6 md:px-8 py-12 md:py-20 bg-gradient-to-br from-purple-50 to-pink-50">
            <div className="max-w-md">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Each discovery box contains a unique puzzle highlighting an exemplary community member, themed goodies, and a story that highlights their journey of wellness, and working within the movement.
              </p>
